  ...
  <div className=" mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
    ...
    >
      ...
      <footer className="bg-[#f9f9f9] py-8 border-t border-[#f9f9f9]">
        <div className="flex gap-6 mb-8 max-w-full justify-center">
            {/* Instagram */}
            <a 
              href="https://instagram.com/doggofitve" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-slate-400 hover:text-slate-400 transition-all duration-300 transform hover:scale-110"
