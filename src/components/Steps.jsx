...
import { Smartphone, Home, Dog } from 'lucide-react';
    ...
    >
      ...
      <motion.div variants={cardVariants} className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] cursor-pointer border border-gray-100">
        <div className="aspect-[16/9] w-full bg-[#e2b220] flex items-center justify-center">
          {/* Cambiamos el Truck por Home */}
          <Home className="w-20 h-20 text-white" strokeWidth={1.5} />
        </div>
        <div className="p-6 flex flex-col flex-grow">
          <h3 className="text-[22px] font-bold text-[#4c4c4c] mb-2">2. El gym va a tu casa</h3>
          <p className="text-[#4c4c4c]/80 flex-grow">Llevamos e instalamos nuestra cinta profesional directamente en la comodidad y seguridad de tu domicilio.</p>
        </div>
      </motion.div>
      ...
      <motion.div variants={cardVariants} className="flex flex-col bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] cursor-pointer border border-gray-100">
        ...
        <div className="p-6 flex flex-col flex-grow">
          <h3 className="text-[22px] font-bold text-[#4c4c4c] mb-2">3. Medimos su progreso</h3>
          <p className="text-[#4c4c4c]/80 flex-grow">Tu perro drena su energía bajo supervisión, mientras estudiamos su evolución física para optimizar cada sesión.</p>
        </div>
      </motion.div>
